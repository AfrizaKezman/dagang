        ...
        <div className="flex items-center justify-between h-16">
          ...
          <Link href={isLoggedIn ? (user?.role === 'admin' ? '/admin' : '/products') : '/'} 
            ...
            <span className="flex items-center space-x-2">
              <div className="w-8 h-8 bg-gradient-to-br from-yellow-400 to-yellow-500 rounded-lg shadow-lg flex items-center justify-center">
                <ShopIcon className="w-5 h-5 text-white" />
              </div>
              <span className="text-xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-yellow-500 to-yellow-400">
                GudangLaris
              </span>
            </span>
          </Link>
          ...
          <div className="hidden md:flex md:items-center md:space-x-8">
            {isLoggedIn ? (
              <>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <button
                    ...
                    className="px-4 py-2 rounded-full text-sm font-medium text-white bg-gradient-to-r from-yellow-500 to-yellow-400 hover:from-yellow-600 hover:to-yellow-500 transition-all duration-200"
                  >
                    Logout
                  </button>
                </div>
              ...
              <button
                onClick={handleLogin}
                className="px-6 py-2 rounded-full text-sm font-medium text-white bg-gradient-to-r from-yellow-500 to-yellow-400 hover:from-yellow-600 hover:to-yellow-500 transition-all duration-200"
              >
                Login
              </button>
            )}
          ...
          <div className="md:hidden">
            {isLoggedIn ? (
              ...
              <button
                onClick={handleLogin}
                className="px-4 py-2 rounded-full text-sm font-medium text-white bg-gradient-to-r from-yellow-500 to-yellow-400 hover:from-yellow-600 hover:to-yellow-500"
              >
                Login
              </button>
            )}
          ...
          <div className="px-2 pt-2 pb-3 space-y-1 bg-white/90 backdrop-blur-lg border-t border-gray-200">
            ...
            <div className="pt-4 mt-2 border-t border-gray-200">
              ...
              <button
                ...
                className="w-full px-4 py-2 text-sm font-medium text-white bg-gradient-to-r from-yellow-500 to-yellow-400 hover:from-yellow-600 hover:to-yellow-500 rounded-full transition-all duration-200"
              >
                Logout
              </button>
            </div>
...
function MobileNavLink({ href, icon, text, onClick }) {
  return (
    <Link
      href={href}
      onClick={onClick}
      className="flex items-center px-3 py-2 rounded-lg text-sm font-medium text-gray-700 hover:bg-yellow-50 hover:text-yellow-600 transition-all duration-200"
    >
      <span className="text-yellow-500">{icon}</span>
      <span className="ml-2">{text}</span>
    </Link>
